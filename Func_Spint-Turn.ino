...
void TL(int speedTurnLeft, int speedTurnRight, float time) {
  float target_degree = current_degree - 90;
  if (target_degree > 180) target_degree -= 360;
  if (target_degree < -180) target_degree += 360;
  current_degree = target_degree;
...
void TR(int speedTurnLeft, int speedTurnRight, float time) {
  float target_degree = current_degree + 90;
  if (target_degree > 180) target_degree -= 360;
  if (target_degree < -180) target_degree += 360;
  current_degree = target_degree;
...
void TR_B(float time) {
  ...
  if (target_degree < -180) target_degree += 360;
  current_degree = target_degree;
  motorWrite(-10, -10, -60, -60);
  delay(time * power_factor);
  motorStop();
}

void TL_B(int speedTurnRight, int speedTurnLeft, float time) {
  float target_degree = current_degree - 90;
  if (target_degree > 180) target_degree -= 360;
  if (target_degree < -180) target_degree += 360;
  current_degree = target_degree;
...
void TR_B(int speedTurnRight, int speedTurnLeft, float time) {
  float target_degree = current_degree + 90;
  if (target_degree > 180) target_degree -= 360;
  if (target_degree < -180) target_degree += 360;
  current_degree = target_degree;
