...
int sensor_min[] = { 200, 200, 200, 200, 200, 400, 500, 100 };  // ค่าสีเขียว
int sensor_max[] = { 802, 854, 863, 840, 852, 858, 900, 756 };  // ค่าสีขาว
...
int ServoFront_Drop = 50;  // ปล่อยลูกบาศก์หน้า S1

//----------ค่าเซอร์โว 0 ด้านหลัง----------//
int CH_SERVO_BACK = 0;    // ช่องที่เสียบเซอร์โว ชุดปล่อยหลัง
int ServoBack_Lock = 10;  // ล็อคลูกบาศก์หลัง S0
int ServoBack_Drop = 50;  // ปล่อยลูกบาศก์หลัง S0
